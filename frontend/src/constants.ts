...
// 日志/尝试事件状态文案
export const LOG_STATUS_META: Record<string, { label: string; color: string }> = {
 ...
 */
export function breakerDescription(node: TaskNode | undefined, cb: CircuitBreaker | undefined, now: number): {
  label: string
  color: string
  detail: string
} {
